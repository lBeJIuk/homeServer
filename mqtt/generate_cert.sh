...
COMPOSE_PROJECT_DIR="/store/mosquitto"
IP="mosquitto"
...
function copy_keys_to_broker () {
   mkdir -p $COMPOSE_PROJECT_DIR/conf/certs/
   cp $COMPOSE_PROJECT_DIR/certs/ca.crt $COMPOSE_PROJECT_DIR/conf/certs/
   cp $COMPOSE_PROJECT_DIR/certs/server.crt $COMPOSE_PROJECT_DIR/conf/certs/
   cp $COMPOSE_PROJECT_DIR/certs/server.key $COMPOSE_PROJECT_DIR/conf/certs/
}
